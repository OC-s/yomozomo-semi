...
<div class="container">
<form action="qaAddOk.jsp" method="post" >
	<table class="table table-striped">
		...
		<tr>
			<td colspan="2">
				<a href="b_mngmn2.jsp"><input type="button" value="작성취소" class="btn btn-secondary" /></a>
...
<%
		...
		script.println("location.href = 'b_mngmn2.jsp'");		
		script.println("</script>");
	}
%>		
    	</div>
