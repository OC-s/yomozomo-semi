...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    QaboardDAO qdao = new QaboardDAO();
    QaboardVO qvo = qdao.selectOne(q);
    
    MemberDAO mdao = new MemberDAO();
    MemberVO mvo = mdao.selectOne(qvo.getM_NUM());
    
    %>
    <section class="content">
    	<!-- 수정완료 버튼 누르면 입력한 데이터 내용으로 db에서 수정될 수 있도록 하기 -->
<div class="container">
<form action="qamodifyOk.jsp" method="post" >
	<table class="table table-striped">
		<tr>
			<th>작성자id</th>
			<td>
				<input type="hidden" name="qanum" id="qanum" value="<%=qvo.getQAB_NUM() %>" />
		...
		<tr>
			<th>작성일시</th>
			<td><input type="text" name="regdate" value="<%=qvo.getQAB_REGDATE() %>" disabled /></td>
		</tr>
		<tr>
			<th>제목</th>
			<td><input type="text" name="title" id="title" value="<%=qvo.getQAB_TITLE() %>" /></td>
		</tr>
		<tr>
			<th>내용</th>
			<td>
				<textarea name="contents" id="summernote" cols="80" rows="20"><%=qvo.getQAB_CONTENTS() %></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<a href="b_mngmn2.jsp"><input type="button" value="수정취소" class="btn btn-secondary" /></a>
