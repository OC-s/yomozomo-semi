	...
	<form method="post" action="pic_commentsOk.jsp">
		...
		<table class="table "
			...
			<tr>
				...
				<td><input type="hidden" name="writer" id=""
					value="<%=log.getID()%>" /> <input type="hidden" name="m_num"
					id="" value="<%=log.getM_NUM()%>" /> <input type="hidden"
					name="b_num" id="" value="<%=vo.getB_NUM()%>" /></td>
